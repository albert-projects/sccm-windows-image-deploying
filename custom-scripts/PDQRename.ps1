...
$variableName2 = "NewComputerName"
$variable2 = $NewName


Invoke-Command -Session $sess -ArgumentList $Exe_Location, $variableName, $variable, $variableName2, $variable2 -ScriptBlock {

    param($Exe_Location, $variableName, $variable, $variableName2, $variable2 )
