...
#write-eventLog -LogName MDT -Message $ComputerTarget -Source Trigger -id 2001 -ComputerName VWSPMSDT01
Invoke-Command -Computer "VWSPMSDT01" -ArgumentList $ComputerTarget -ScriptBlock { 

    param($Msg)

    write-eventLog -LogName MDT -Message $Msg -Source Trigger -id 2001 -ComputerName VWSPMSDT01
